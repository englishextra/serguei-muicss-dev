...
(function(root, document) {
	...
	var run = function run() {
		...
		var manageDataSrcImgAll = function manageDataSrcImgAll() {
			root[_addEventListener]("scroll", handleDataSrcImgAllWindow, {
				passive: true
			});
		...
		var manageBtnTotop = function manageBtnTotop() {
			...
			if (docBody) {
				...
				root[_addEventListener]("scroll", handleWindow, {
					passive: true
				});
			}
		};
      ...
      to get milliseconds */
		...
		var manageInstagramEmbedAll = function manageInstagramEmbedAll() {
			...
			var instagramMedia =
				document[getElementsByClassName](instagramMediaClass)[0] || "";

			var initScript = function initScript() {
				try {
					var instagramMedia =
						document[getElementsByClassName](instagramMediaClass) ||
						"";
		...
		var manageTwitterEmbedAll = function manageTwitterEmbedAll() {
			...
			var twitterTweet =
				document[getElementsByClassName](twitterTweetClass)[0] || "";

			var initScript = function initScript() {
				try {
					var twitterTweet =
						document[getElementsByClassName](twitterTweetClass) ||
						"";
		...
		var manageVkEmbedAll = function manageVkEmbedAll() {
			...
			var initScript = function initScript() {
				...
				try {
					var vkPost =
						document[getElementsByClassName](vkPostClass) || "";
